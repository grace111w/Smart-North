...
// import Input from "../component/Input";
// import { auth } from "../../FireBaseconfig";
// import { signInWithEmailAndPassword, onAuthStateChanged, checkActionCode } from "firebase/auth";
// import smart from "../img/IMG_1272.jpg";
// import { useFonts } from "expo-font";
// export default Loginpage;
// const Loginpage = (props) => { const [email, setEmail] = React.useState("");
// const [password, setPassword] = React.useState("");
// const [user, setUser] = React.useState(null);
// const handleLogin = () => {
//   signInWithEmailAndPassword(auth, email, password)
...
// }, []); */
// React.useEffect(() => {
//   const unsubscribie = onAuthStateChanged(auth, (user) => {
//     if (user) {
//       setUser(admin)
...
//       />
//       <View style={styles.scrollContainer}>
//         <Pressable style={styles.button} onPress={(user) => {
//     if (user) {
//       setUser(admin)
//       props.navigation.navigate("admin");}
//     else if (user) {
